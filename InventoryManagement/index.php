...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
			...
			<li class="active">
        		<a href="user homepage.php" aria-expanded="true" target="_blank">
        ...
        <div class="main-content">
            ...
            <div class="page-title-area">
                ...
                <a class="dropdown-item" href="../Sign-up.php">Register Account for admin </a>                 
		...
		<video id="myVideo" width="100%" autoplay loop>
    		<source src="../burger1.mp4" type="video/mp4">
		</video>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright Louise Burger. All right reserved. </p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
