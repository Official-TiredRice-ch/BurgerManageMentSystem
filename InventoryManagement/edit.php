...
<form action="" method="post" action="edit.php">
    ...
    <table>
        <tr>
            <td colspan="2"><b><font color='#3498db'>Edit Records</font></b></td>
        </tr>
        <tr>
            <td width="179"><b><font color='#3498db'>Item Name<em>*</em></font></b></td>
            <td>
                <label>
        ...
        <tr>
            <td width="179"><b><font color='#e74c3c'>Price<em>*</em></font></b></td>
            <td>
                <label>
        ...
        <tr>
            <td width="179"><b><font color='#2ecc71'>Quantity<em>*</em></font></b></td>
            <td>
                <label>
