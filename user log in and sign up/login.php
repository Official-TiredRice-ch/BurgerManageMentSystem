...
<head>
 <video autoplay loop style="position: fixed; left:0; right:0;" volume="0.2">
        <source src="../InventoryManagement/burger ads/burger add2.mp4" type="video/mp4">
     </video>
 ...
 <?php
		 ...
		 $errorMessage = '';
            if (isset($_POST["login_button"])) {
                ...
                $p=crud::conect()->prepare("SELECT * FROM user WHERE name=:n and pass=:p");
                $p->bindValue(":n",$name);
                ...
                if ($p->rowCount()>0) {
                    ...
                    header("location:../InventoryManagement/User homepage.php");
                }else {
