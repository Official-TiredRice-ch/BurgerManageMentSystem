...
<body>
 ...
 <?php
        ...
        if (isset($_POST["signUP_button"])) {
            ...
            if (!empty($name) && !empty($email) && !empty($password)) {
                if ($password == $confipassword) {
                    $p = crud::conect()->prepare("INSERT INTO user (name,email,pass) VALUES(:n,:e,:p)");
                    $p->bindValue(":n", $name);
                    $p->bindValue(":e", $email);
	...
	<br>
            ...
            <p class="violet"> Account Register <class="violet"></p>
	<hr>
        </div>
        ...
        <form action="" method="post">
            ...
            <a href="./login.php" class="violet">Do you have account? Sign in</a>
        </form>
    </div>
